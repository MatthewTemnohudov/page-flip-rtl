...
export abstract class Render {
    ...
    public convertRectToGlobal(rect: RectPoints, direction?: FlipDirection): RectPoints {
        ...
        return {
            ...
            // topLeft: this.convertToGlobal(rect.topRight, direction),
            // topRight: this.convertToGlobal(rect.topLeft, direction),
            // bottomLeft: this.convertToGlobal(rect.bottomRight, direction),
            // bottomRight: this.convertToGlobal(rect.bottomLeft, direction),
        };
    }
